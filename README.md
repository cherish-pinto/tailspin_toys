...
The homepage includes instant filters for the catalog. Select one or more categories to match any selected category, choose a publisher, or combine both controls to narrow the results. Use **Clear filters** to restore the full catalog; filtering does not reload the page.
...
Project-wide coding standards are maintained in
[`.github/copilot-instructions.md`](.github/copilot-instructions.md) and the
focused guides in [`.github/instructions`](.github/instructions). They cover
commenting intent rather than mechanics, TSDoc/JSDoc for exported data-layer
functions, documented Astro component props, and the TypeScript formatting rules
enforced by ESLint.
